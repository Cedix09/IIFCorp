...
$sql = "INSERT INTO Student (name, email, phone_number, contry, city, postal_code, program) VALUES ('$name', '$email', '$phone_number', '$contry', '$city', '$postal_code', '$program')";
...
<div class="fed2">
  <div class="form-container">
    ...
    <form action="" method="POST">
      <button><a href="indexru.html">Назад на главную страницу</a></button>
    </form>
  </div>
  </div>
  <footer>
